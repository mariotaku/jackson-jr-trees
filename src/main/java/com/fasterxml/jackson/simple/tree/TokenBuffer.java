...
/**
 * Utility class used for efficient storage of {@link com.fasterxml.jackson.core.JsonToken}
    ...
    extends JsonGenerator
{
     ...
     *   such methods can not be used.
     *
     * @deprecated since 2.3 preferred variant is one that takes {@link com.fasterxml.jackson.core.JsonParser} or additional boolean parameter.
     */
    @Deprecated
     ...
     *   conversion through parser/generator interfaces. If null,
     *   such methods can not be used.
     * @param hasNativeIds Whether resulting {@link com.fasterxml.jackson.core.JsonParser} (if created)
    ...
    /**
     * Method used to create a {@link com.fasterxml.jackson.core.JsonParser} that can read contents
     ...
     * using given {@link com.fasterxml.jackson.core.JsonGenerator}.
     *<p>
...
*/
        ...
        extends ParserMinimalBase
    {
        ...
        @Override
        public Version version() {
            return new com.fasterxml.jackson.simple.tree.PackageVersion().version();
        }
    ...
    protected final static class Segment
    {
         ...
         * matching {@link com.fasterxml.jackson.core.JsonToken} instances
         */
