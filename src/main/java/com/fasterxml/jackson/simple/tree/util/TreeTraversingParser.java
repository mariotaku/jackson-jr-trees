...
public class TreeTraversingParser extends ParserMinimalBase
{
    ...
    public TreeTraversingParser(JacksonJrValue n) { this(n, null); }

    public TreeTraversingParser(JacksonJrValue n, ObjectCodec codec)
    {
        super(0);
        _objectCodec = codec;
        if (n.isArray()) {
            _nextToken = JsonToken.START_ARRAY;
            _nodeCursor = new NodeCursor.ArrayCursor((JsonArray) n, null);
        } else if (n.isObject()) {
            _nextToken = JsonToken.START_OBJECT;
            _nodeCursor = new NodeCursor.ObjectCursor((JsonObject) n, null);
        } else { // value node
...
//        case VALUE_EMBEDDED_OBJECT:
    ...
    public NumberType getNumberType() throws IOException {
        JacksonJrValue n = currentNumericNode();
    ...
    protected JacksonJrValue currentNode() {
    ...
    protected JsonNumber currentNumericNode() throws JsonParseException
    {
        JacksonJrValue n = currentNode();
        if ((n == null) || !(n instanceof JsonNumber)) {
